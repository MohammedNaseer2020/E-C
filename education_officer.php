...
// جلب طلبات الدورات التي تحتاج قرار من ضابط التعليم (من جميع الأقسام)
$sql = "SELECT DISTINCT 
    ce.*, 
...
WHERE 
    ce.current_stage = 'education_officer'
    AND (cd.decision IS NULL OR cd.decision = 'pending')
ORDER BY 
    ce.created_at DESC";
...
<head>
    ...
    <title>قرارات دورات الموظفين - ضابط التعليم </title>
    <style>
        .table-warning {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="decisionForm">
                    ...
                    <input type="hidden" name="stage" value="education_officer">
