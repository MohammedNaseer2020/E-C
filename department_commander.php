...
WHERE 
    ce.id_department = ?
    AND ce.current_stage = 'department_commander'
...
<head>
    <meta charset="UTF-8">
    <title>قرارات دورات الموظفين - قائد القسم - <?= htmlspecialchars($department_name) ?></title>
</head>
<body>
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">
                <i class="fas fa-clipboard-check me-2"></i>
                     قائد القسم - <?= htmlspecialchars($department_name) ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="decisionForm">
                    ...
                    <input type="hidden" name="stage" value="department_commander">
