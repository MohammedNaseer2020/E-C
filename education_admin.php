...
// جلب طلبات الدورات التي تحتاج قرار من إداري التعليم (من جميع الأقسام)
$sql = "SELECT DISTINCT 
    ce.*, 
...
WHERE 
    ce.current_stage = 'education_admin'
...
<head>
    ...
    <title>قرارات دورات الموظفين - إداري التعليم  </title>
    <style>
        .table-warning {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="decisionForm">
                    ...
                    <input type="hidden" name="stage" value="education_admin">
