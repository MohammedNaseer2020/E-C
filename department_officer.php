...
WHERE 
    ce.id_department = ?
    AND ce.current_stage = 'department_officer'
...
<head>
    ...
    <title> - ضابط القسم <?= htmlspecialchars($department_name) ?></title>
    <style>
        .table-warning {
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">
                ...
                ضابط قسم - <?= htmlspecialchars($department_name) ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="decisionForm">
                    ...
                    <input type="hidden" name="stage" value="department_officer">
                    ...
                    <div class="mb-3">
                        <label class="form-label">سبب التنسيب</label>
                        <textarea class="form-control" name="placement_reason" rows="3" required></textarea>                    </div>
                    <div class="mb-3">
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data) {
                    ...
                    $('textarea[name="placement_reason"]').val(data.placement_reason || '');
                }
            },
